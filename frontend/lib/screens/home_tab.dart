...
import 'responsive_design_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            tooltip: 'Responsive Design Demo',
            onPressed: () {
              Navigator.pushNamed(context, ResponsiveDesignScreen.routeName);
            },
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.pushNamed(context, MultiDeviceCheckScreen.routeName);
            },
